...
public class OAuth2Service implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest oAuth2UserRequest) throws OAuth2AuthenticationException {
        checkUserInfo(oAuth2UserRequest);
        ...
        try {
            response = this.restOperations.exchange(requestEntityConverter.convert(oAuth2UserRequest), PARAMETERIZED_RESPONSE_TYPE);
        } catch (OAuth2AuthorizationException ex) {
            getErrorDetails(oAuth2UserRequest, ex);
        ...
        Map<String, Object> userAttributes = getUserAttributes(oAuth2UserRequest, response);
